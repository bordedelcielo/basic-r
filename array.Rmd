...
```{r}
vector_1 = c(11,12,13,14,15,16,17,18,19)
vector_2 = c(31,32,33,34,35,36,37,38,39)
matrix_1 = matrix(vector_1, 3, 3)
matrix_2 = matrix(vector_2, 3, 3)
matrix_1
matrix_2
```
...
```{r}
array(c(1,2,3,4,5,6,7,8,9), c(3,3,2))
